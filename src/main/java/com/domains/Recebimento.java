...
public class Recebimento {
    ...
    public Recebimento(Long idRecebimento, Lancamento lancamento, Date dataRecebimento, BigDecimal valorRecebido, ContaBancaria contaDestino, String observacao) {
